angular
    ...
    .run([
      ...
      function ($templateCache) {
            ...
            "<label><input type=\"radio\"  ng-change=\"treeTableControl.addPatientBtn(true)\" ng-value=\"true\"/ ng-model=\"pateient_type\" ng-click=\"isDisabled = false;\"  value=\"1\" />Do you want to type in data</label>\n" +
            "<label><input type=\"radio\"  ng-change=\"treeTableControl.addPatientBtn(false)\" ng-value=\"false\"/ ng-model=\"pateient_type\" ng-click=\"isDisabled = true;treeTableControl.removePatient()\"  value=\"2\" />Do you want to upload file</label>\n" +
            "</span>\n" +*/
            ...
            "          <td>\n" +
            "          <input ng-disabled=\"isDisabled\"  type=\"text\" name=\"id{{row1.treeIndex}}\" id=\"id{{row1.treeIndex}}\" ng-model=\"row1.patient[row1.treeIndex].id\" required>\n" +
            ...
            "        <td>\n" +
            "        <input ng-disabled=\"isDisabled\" type=\"date\" name=\"age{{row1.treeIndex}}\" id=\"age{{row1.treeIndex}}\" ng-model=\"row1.patient[row1.treeIndex].age\" required>\n" +
            ...
            "        <td>\n" +
            "          <select ng-disabled=\"isDisabled\" name=\"sex{{row1.treeIndex}}\" id=\"sex{{row1.treeIndex}}\" ng-model=\"row1.patient[row1.treeIndex].sex\" required>\n" +
            ...
            "          <td>\n" +
            "            <select ng-disabled=\"isDisabled\" name=\"education{{row1.treeIndex}}\" id=\"education{{row1.treeIndex}}\" ng-model=\"row1.patient[row1.treeIndex].education\" required>\n" +
            ...
            "         <input ng-model=\"row1.patient[row1.treeIndex].test[row.id]\" name=\"test{{row1.treeIndex}}_{{row.id}}\" id=\"test{{row1.treeIndex}}_{{row.id}}\"  ng-disabled=\"isDisabled\" type=\"number\" min=\"{{row.branch.lowweb}}\" max=\"{{row.branch.highweb}}\" required>\n" +
